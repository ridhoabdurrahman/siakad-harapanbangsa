            ...
            !(function (e) {
                    ...
                    (this._bodyInit = t),
                      t
                        ? "string" == typeof t
                          ...
                          : s &&
                            (ArrayBuffer.prototype.isPrototypeOf(t) || l(t))
              ...
              function b(t, e) {
                ...
                if (
                  ...
                  (this.method =
                    ((o = (n = e.method || this.method || "GET").toUpperCase()),
                    v.indexOf(o) > -1 ? o : n)),
    ...
    return (
      (function () {
        ...
        function l(t, e, n) {
          ...
          return i() ? {} : { obj: t, k: o(r.shift()) };
        }
        function u(t, e, n) {
          const { obj: o, k: i } = l(t, e, Object);
          o[i] = n;
        }
        function c(t, e) {
          const { obj: n, k: o } = l(t, e);
          if (n) return n[o];
        }
        function p(t, e, n) {
          for (const o in e)
          ...
          for (let t = 0; t < o.length; ++t) {
            ...
            if (void 0 === i[o[t]]) {
              let r = 2,
                ...
                a = i[s];
              for (; void 0 === a && o.length > t + r; )
                r++, (s = o.slice(t, t + r).join(n)), (a = i[s]);
              if (void 0 === a) return;
        ...
        class v extends o {
          ...
          getResource(t, e, n) {
            ...
            return a || !r || "string" != typeof n
              ? a
              : y(this.data && this.data[t] && this.data[t][e], n, i);
          }
          addResource(t, e, n, o) {
            let i =
            ...
            n && (s = s.concat(r ? n.split(r) : n)),
              t.indexOf(".") > -1 && ((s = t.split(".")), (o = e), (e = s[1])),
        ...
        var b = {
          ...
          handle(t, e, n, o, i) {
            return (
              t.forEach((t) => {
                this.processors[t] &&
                  (e = this.processors[t].process(e, n, o, i));
              }),
              e
            );
          },
        ...
        class x extends o {
          ...
          extractFromKey(t, e) {
            ...
            if (r && !s) {
              ...
              if (e && e.length > 0) return { key: t, namespaces: i };
              const r = t.split(n);
              (n !== o || (n === o && this.options.ns.indexOf(r[0]) > -1)) &&
                (i = r.shift()),
                (t = r.join(o));
            }
          ...
          translate(t, e, n) {
            ...
            const o =
              ...
              i =
                void 0 !== e.keySeparator
                  ? e.keySeparator
                  : this.options.keySeparator,
              { key: r, namespaces: s } = this.extractFromKey(
                t[t.length - 1],
                e
              ),
              a = s[s.length - 1],
            ...
            if (l && "cimode" === l.toLowerCase()) {
              ...
              return o
                ? { res: r, usedKey: r, exactUsedKey: r, usedLng: l, usedNS: a }
                : r;
            }
            ...
            if (
              ...
              if (i) {
                ...
                for (const t in p)
                  if (Object.prototype.hasOwnProperty.call(p, t)) {
                    const r = `${o}${i}${t}`;
                    (n[t] = this.translate(r, { ...e, joinArrays: !1, ns: s })),
                      n[t] === r && (n[t] = p[t]);
                  }
                p = n;
              }
            } else if (y && "string" == typeof g && "[object Array]" === d)
              (p = p.join(g)), p && (p = this.extendTranslation(p, t, e, n));
            else {
              let o = !1,
                s = !1;
              const u = void 0 !== e.count && "string" != typeof e.count,
                ...
                g =
                  ...
                  e[`defaultValue${d}`] ||
                  e.defaultValue;
              !this.isValidLookup(p) && h && ((o = !0), (p = g)),
                this.isValidLookup(p) || ((s = !0), (p = r));
              const y =
              ...
              if (s || o || m) {
                if (
                  ...
                  const t = this.resolve(r, { ...e, keySeparator: !1 });
                  t &&
                    t.res &&
                    this.logger.warn(
                ...
                const o = (t, n, o) => {
                  ...
                  this.options.missingKeyHandler
                    ? this.options.missingKeyHandler(t, a, n, i, m, e)
                    : this.backendConnector &&
                      this.backendConnector.saveMissing &&
                      this.backendConnector.saveMissing(t, a, n, i, m, e),
                    this.emit("missingKey", t, a, n, p);
                };
              ...
              (p = this.extendTranslation(p, t, e, c, n)),
                s &&
                  p === r &&
                  ...
                  (t = this.interpolator.nest(
                    ...
                    function () {
                      for (
                        ...
                        o[s] = arguments[s];
                      return i && i[0] === o[0] && !n.context
                        ? (r.logger.warn(
                            `It seems you are nesting recursively key: ${o[0]} in key: ${e[0]}`
                          ),
                          null)
                        : r.translate(...o, e);
                    },
                  ...
                  this.isValidLookup(e) ||
                    ...
                    f.forEach((n) => {
                      ...
                      if (this.i18nFormat && this.i18nFormat.addLookupKeys)
                        this.i18nFormat.addLookupKeys(r, l, n, t, s);
                      else {
                        let t;
                        ...
                        if (
                          (c &&
                            ...
                            s.ordinal &&
                              0 === t.indexOf(o) &&
                              r.push(
                                l + t.replace(o, this.options.pluralSeparator)
                              ),
                            p && r.push(l + e)),
                          h)
                        ) {
                          ...
                          r.push(n),
                            c &&
                              ...
                              s.ordinal &&
                                0 === t.indexOf(o) &&
                                r.push(
                                  n + t.replace(o, this.options.pluralSeparator)
                                ),
                              p && r.push(n + e));
                        }
                      }
                      ...
                      for (; (a = r.pop()); )
                        this.isValidLookup(e) ||
                          ((o = a), (e = this.getResource(n, t, a, s)));
                    }));
                });
              }),
              { res: e, usedKey: n, exactUsedKey: o, usedLng: i, usedNS: r }
            );
          }
          isValidLookup(t) {
            return !(
          ...
          getSuffixes(t) {
            ...
            return n
              ? this.shouldUseIntlApi()
                ? n
                    .resolvedOptions()
                    .pluralCategories.sort((t, e) => j[t] - j[e])
                    .map(
                      (t) =>
                ...
                : n.numbers.map((n) => this.getSuffix(t, n, e))
              : [];
          }
          getSuffix(t, e) {
            let n =
            ...
            return o
              ? this.shouldUseIntlApi()
                ...
                : this.getSuffixRetroCompatible(o, e)
        ...
        class C {
                ...
                for (s = 0; (i = e.regex.exec(t)); ) {
                  ...
                  if (((r = c(n)), void 0 === r))
                    if ("function" == typeof p) {
                      ...
                      this.logger.warn(
                        `missed to pass in variable ${n} for interpolating ${t}`
                      ),
                        (r = "");
                    }
                  else
          ...
          nest(t, e) {
            ...
            for (; (n = this.nestingRegexp.exec(t)); ) {
              ...
              if (
                ((o = e(s.call(this, n[1].trim(), i), i)),
                o && n[0] === t && "string" != typeof o)
              )
                return o;
              "string" != typeof o && (o = a(o)),
                o ||
                  (this.logger.warn(
                    `missed to resolve ${n[1]} for nesting ${t}`
                  ),
                  (o = "")),
                u &&
                  (o = l.reduce(
                    (t, e) =>
                      this.format(t, e, r.lng, {
                        ...r,
        ...
        class $ {
          ...
          format(t, e, n) {
            ...
            return e.split(this.formatSeparator).reduce((t, e) => {
              const { formatName: i, formatOptions: r } = (function (t) {
                  ...
                  "currency" === e && i.indexOf(":") < 0
                    ...
                    : i.split(";").forEach((t) => {
                        ...
                        n[e.trim()] || (n[e.trim()] = i),
                          "false" === i && (n[e.trim()] = !1),
                          "true" === i && (n[e.trim()] = !0),
                          isNaN(i) || (n[e.trim()] = parseInt(i, 10));
                      });
                }
              ...
              return (
                this.logger.warn(`there was no format function for ${i}`), t
              );
            }, t);
          }
        }
        class A extends o {
          constructor(t, e, o) {
            ...
            super(),
              ...
              this.backend &&
                this.backend.init &&
                this.backend.init(o, i.backend, i);
          }
          queueLoad(t, e, n, o) {
            const i = {},
              r = {},
            ...
            return (
              t.forEach((t) => {
                ...
                e.forEach((e) => {
                  const s = `${t}|${e}`;
                  !n.reload && this.store.hasResourceBundle(t, e)
                    ? (this.state[s] = 2)
                    : this.state[s] < 0 ||
                      (1 === this.state[s]
                        ? void 0 === r[s] && (r[s] = !0)
          ...
          loaded(t, e, n) {
            const o = t.split("|"),
              i = o[0],
              r = o[1];
            e && this.emit("failedLoading", i, r, e),
              n && this.store.addResourceBundle(i, r, n),
              (this.state[t] = e ? -1 : 2);
            const s = {};
            this.queue.forEach((n) => {
              !(function (t, e, n, o) {
                const { obj: i, k: r } = l(t, e, Object);
                (i[r] = i[r] || []), i[r].push(n);
              })(n.loaded, [i], r),
                (function (t, e) {
                  void 0 !== t.pending[e] &&
          ...
          loadOne(t) {
            ...
            this.read(o, i, "read", void 0, void 0, (n, r) => {
              n &&
                this.logger.warn(
                  `${e}loading namespace ${i} for language ${o} failed`,
                  n
                ),
                !n &&
                  r &&
                  this.logger.log(
                    `${e}loaded namespace ${i} for language ${o}`,
                    r
                  ),
                this.loaded(t, n, r);
            });
          ...
          saveMissing(t, e, n, o, i) {
            ...
            if (
              ...
              this.logger.warn(
                `did not save key "${n}" as the namespace "${e}" was not yet loaded`,
                "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!"
              );
            else if (null != n && "" !== n) {
              if (this.backend && this.backend.create) {
                const a = { ...r, isUpdate: i },
                  l = this.backend.create.bind(this.backend);
                if (l.length < 6)
                  try {
                    let i;
                    (i = 5 === l.length ? l(t, e, n, o, a) : l(t, e, n, o)),
                      i && "function" == typeof i.then
                        ? i.then((t) => s(null, t)).catch(s)
                        : s(null, i);
                  } catch (t) {
                    s(t);
                  }
        ...
        class U extends o {
          ...
          init() {
            ...
            if (
              ((this.options = { ...i, ...this.options, ...D(e) }),
              "v1" !== this.options.compatibilityAPI &&
                (this.options.interpolation = {
                  ...i.interpolation,
                  ...this.options.interpolation,
              ...
              (s.logger = n),
                ...
                (s.interpolator = new C(this.options)),
                (s.utils = {
            ...
            if (
              ...
              n
                ...
                this.options.preload &&
                  this.options.preload.forEach((t) => o(t)),
            ...
            const i = function (t, e) {
              ...
              if ("object" != typeof e) {
                for (
                  ...
                  a[l - 2] = arguments[l];
                r = o.options.overloadTranslationOptionHandler(
                  [t, e].concat(a)
                );
              } else r = { ...e };
              (r.lng = r.lng || i.lng),
                (r.lngs = r.lngs || i.lngs),
                (r.ns = r.ns || i.ns),
                (r.keyPrefix = r.keyPrefix || n || i.keyPrefix);
              const u = o.options.keySeparator || ".";
              let c;
              return (
                (c =
                  r.keyPrefix && Array.isArray(t)
                    ? t.map((t) => `${r.keyPrefix}${u}${t}`)
                    : r.keyPrefix
                    ? `${r.keyPrefix}${u}${t}`
                    : t),
                o.t(c, r)
          ...
          dir(t) {
            if (
              ...
              return "rtl";
            const e =
              (this.services && this.services.languageUtils) || new k(I());
            return [
              "ar",
              "shu",
              "sqr",
          ...
          cloneInstance() {
            ...
            return (
              ...
              n &&
                ((i.store = new v(this.store.data, o)),
                (i.services.resourceStore = i.store)),
              (i.translator = new x(i.services, o)),
        ...
        (_.createInstance = U.createInstance),
          _.createInstance,
          _.dir,
          _.init,
          _.loadResources,
        ...
        function V(t) {
          return (
            H.call(q.call(arguments, 1), function (e) {
        ...
        var Q = function (t, e) {
          ...
          Z = function (t, e, n) {
            var o = function (t) {
              if (!t.ok)
                return n(t.statusText || "Error", { status: t.status });
              t.text()
                .then(function (e) {
            ...
            "function" == typeof fetch
              ? fetch(t, e).then(o).catch(n)
              : J(t, e).then(o).catch(n);
          },
          tt = !1,
          et = function (t, e, n, o) {
            return (
              ...
              J && 0 !== e.indexOf("file:")
                ...
                ? (function (t, e, n, o) {
                    n && "object" === Y(n) && (n = Q("", n).slice(1)),
                      t.queryStringParams && (e = Q(e, t.queryStringParams));
                    try {
                      var i;
                      (i = z ? new z() : new X("MSXML2.XMLHTTP.3.0")).open(
                        n ? "POST" : "GET",
                        e,
                        1
                      ),
        ...
        function ot(t, e) {
          for (var n = 0; n < e.length; n++) {
            ...
            (o.enumerable = o.enumerable || !1),
              ...
              Object.defineProperty(t, it(o.key), o);
          }
        }
        function it(t) {
          var e = (function (t, e) {
                ...
                value: function (t, e, n, o) {
                  ...
                  this.options.request(this.options, t, a, function (r, s) {
                    ...
                    if (
                      ...
                      r &&
                      r.message &&
                      r.message.indexOf("Failed to fetch") > -1
                    )
                      return e("failed loading " + t + ": " + r.message, !0);
                    if (r) return e(r, !1);
                    var a, l;
                    try {
                      a =
                        "string" == typeof s.data
                          ? i.options.parse(s.data, n, o)
                          : s.data;
                    } catch (e) {
                ...
                value: function (t, e, n, o, i) {
                  ...
                  if (this.options.addPath) {
                    ...
                    t.forEach(function (n) {
                      ...
                      "function" == typeof r.options.addPath &&
                        (o = r.options.addPath(n, e));
                      ...
                      r.options.request(r.options, c, s, function (e, n) {
                        (a += 1),
                          l.push(e),
                          u.push(n),
                          a === t.length && "function" == typeof i && i(l, u);
                      });
                    });
                  }
                },
                        ...
                        t.allOptions.ns.forEach(function (t) {
                          n.read(e, t, "read", null, null, function (o, r) {
                            o &&
                              ...
                              n.loaded("".concat(e, "|").concat(t), o, r);
                          });
                        });
                      });
                  }
            ...
            lookup: function (t) {
              ...
              if ("undefined" != typeof window) {
                ...
                for (
                  ...
                  var r = o[i].indexOf("=");
                  r > 0 &&
                    o[i].substring(0, r) === t.lookupQuerystring &&
                    (e = o[i].substring(r + 1));
                }
              }
              return e;
                  ...
                  value: function (t) {
                    ...
                    (this.services = t || { languageUtils: {} }),
                      (this.options = (function (t) {
                        return (
                          ct.call(pt.call(arguments, 1), function (e) {
                            if (e)
