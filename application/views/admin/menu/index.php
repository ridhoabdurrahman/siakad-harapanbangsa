<!-- Content -->
<div class="flash-data" data-status="<?= $this->session->flashdata('status') ?>" data-action="<?= $this->session->flashdata('action') ?>" data-message="<?= $this->session->flashdata('message') ?>"></div>
...
<div class="modal fade" id="modalUpdate" data-bs-backdrop="static" tabindex="-1">
    <div class="modal-dialog">
        <form class="modal-content form-update" method="POST">
            <div class="modal-header">
                <h5 class="modal-title" id="backDropModalTitle">Edit Menu</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col mb-3">
                        <label for="menuName" class="form-label">Menu Name</label>
                        <input type="text" id="updateFormName" class="form-control" name="name" placeholder="Enter Menu Name">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
